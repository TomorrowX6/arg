...
- 32 份异常档案，分为六组故事：摄影师的三张照片、街角仍有灯、雨夜补给站、夜班密码实验室、未散场的游园会、无人签收的邮局。
- 三种完整结局，可重新选择与回看，提示使用不会锁定任何结局。
- 27 类谜题与交互：信件取证、密码分析、摩斯电码、调频、虚拟终端、熄灯、记忆复现、路线规划、版本比对、时间排序、数字锁、逻辑推理、数织、紫外显影、滑块拼图、旋转线路、文件取证、天平称量、量水、渡河、推箱子、镜面导光、符号推理、提灯过桥、网络取证、声谱分析、字符隐写。
